...
class UserProfile(Document):
    ...
    inputwikiApi  =StringField(required=True)
    inputyoutubeApi=StringField(required=True)
...
def signup(request):
    if request.method == 'POST':
        try:
            ...
            name = data.get('name')
            inputWikiapi  =data.get('wiki_api')
            inputyoutubeApi=data.get('youtube_api')
            ...
            name=name,         
            wiki_api=inputWikiapi,         
            youtube_api=inputyoutubeApi,         
...
def signup_view(request):
    if request.method == 'POST':
        ...
        try:
            ...
            password = data.get('password')
            name= data.get('name')
            inputWikiapi  =data.get('wiki_api')  #^ 소괄호: html formData (객체변수)☆☆☆☆
            inputyoutubeApi=data.get('youtube_api')
